...
class Generator:
    ...
    def audi_test(self):
        ...
        f.write_videofile('out.mp4', temp_audiofile="temp-audio.m4a", remove_temp=True, codec="libx264",
                          audio_codec="aac")
    ...
    def create(self, desired_length):
        ...
        image = mpe.ImageClip('assets/blue.png').resize(self.clip.size).set_opacity(0.35).set_duration(
            self.total_duration)
        ...
        final.write_videofile('output_file.mp4', audio="temp-audio.m4a", remove_temp=True, codec="libx264",
                              audio_codec="aac")
    ...
    def random_word_screen(self):
        ...
        clip = mpe.TextClip(spaced_word, fontsize=70, color='white', size=self.clip.size, bg_color='black',
                            method='caption', align='center').set_duration(2)
        self.clip_list.append(clip)
        self.total_duration += 2


movie_name = input('Enter your video file name:')
music = input('Enter your audio file name:')
